...
{
    public static Error UserEmailNotFound(string email) => new()
    {
    ...
    public static Error UserIdNotFound(string userId) => new()
    {
        StatusCode = StatusCodes.Status404NotFound,
    ...
    public static Error IncorrectPassword(string userId) => new()
    {
    ...
    public static Error SignInNotAllowed() => new()
    {
    ...
    public static Error SignInFailed() => new()
    {
        StatusCode = StatusCodes.Status400BadRequest,
    ...
    public static Error NameNotValid() => new()
    {
        ...
        Description = "This name is not valid, the length of the alphabetic characters must be greater than or equal to 2."
    };
