...
public interface ITodoRepository
{
    ...
    public Task<Response<Dictionary<int, TaskDTO>>> GetDictionaryAsync(string userId, string? list);
    public Task<Response<IEnumerable<TaskDTO>>> GetListAsync(string userId, string? list);
